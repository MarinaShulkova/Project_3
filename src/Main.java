...
public class Main {
 ...
 /*   static List<Estate> estates = Arrays.asList(
            new Estate("Estate 1", "Tulskaya", "Tulskaya 42", "office", 87, 18328000, 3.2F),
            new Estate("Estate 2", "Altufevo", "Leskova 52/1", "office", 125.8, 27000000, 4.9F),
            new Estate("Estate 3", "Kuzminki", "Zelenodolskaya 35", "kiosk", 15.3, 5236000, 1.8F),
            new Estate("Estate 4", "Ohotnyi ryad", "Krasnaya ploschad 9", "mausoleum", 220, 138000000, 4.28F),
            new Estate("Estate 5", "Krasnoselskaya", "Krasnoselskaya 3a", "shop", 73, 42180000, 4.5F));
*/
}
